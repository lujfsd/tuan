...
//        if($urlMode&&($_GET[C('VAR_MODULE')]!='Payment'&&$_GET[C('VAR_ACTION')]!='response'&&$_GET[C('VAR_MODULE')]!='Chinabank')&&($_GET[C('VAR_MODULE')]!='Goods'&&$_GET[C('VAR_ACTION')]!='advSearch')&&($_GET[C('VAR_MODULE')]!='Goods'&&$_GET[C('VAR_ACTION')]!='pick')) { //修改by 云淡风轻 
//        	
//			// 获取PATHINFO信息
//            self::getPathInfo();
...
//                else 
//                $_URL = substr($_URL, 0, -1).C("URL_HTML_SUFFIX");
//               
//                //重定向成规范的URL格式
