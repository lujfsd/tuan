...
{ /*{{{*/
    public $http_code; 
    public $url; 
    //public $server_domain="localhost:9080";
    public $server_domain="api.tuan800.com";
    //public $server_domain="121.14.229.247:8080";
    public $host = null;
    public $timeout = 10; 
    ...
    public $http_info; 
    public $useragent = 'Tuna800 v1.0.0.1 '; 
...
//        print_r( curl_getinfo($ci) ); 
    ...
    { /*{{{*/
        return 'http://'.$this->server_domain.'/oauth/oauth/accessToken'; 
    } /*}}}*/
    function authorizeURL()
    {/*{{{*/
        return 'http://'.$this->server_domain.'/oauth/oauth/authorize'; 
    } /*}}}*/
    function requestTokenURL() 
    { /*{{{*/
        return 'http://'.$this->server_domain.'/oauth/oauth/requestToken'; 
    } /*}}}*/
