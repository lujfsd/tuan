...
function uc_api_mysql($model, $action, $args=array()) {
	global $uc_controls;
	/*echo "uc_api_mysql<br>";
	print_r($model);echo "<br>";
	print_r($action);echo "<br>";
	print_r($args);echo "<br>";*/
	if(empty($uc_controls[$model])) {
		/*echo "============<br>";
		echo UC_ROOT.'./lib/db.class.php'."<br>";
		echo UC_ROOT.'./model/base.php'."<br>";
		echo UC_ROOT."./control/$model.php"."<br>";
		include_once 'D:/ApacheGroup/Apache2.2/htdocs/groupon/uc_client/lib/db.class.php';
		echo "============<br>";*/
		include_once UC_ROOT.'./model/base.php';
		include_once UC_ROOT."./control/$model.php";
		//print_r("\$uc_controls['$model'] = new {$model}control();");echo "<br>";
