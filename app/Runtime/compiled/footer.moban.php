...
<div class="blank"></div>
	   <?php endif; ?>
            <div class=copyright>
				...
				<?php $_from = $this->_var['foot_navs']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'nav_0_27937500_1406602234');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['nav_0_27937500_1406602234']):
?>
					<?php if ($this->_var['key'] != 0): ?>&nbsp;&nbsp;|&nbsp;&nbsp;<?php endif; ?>
					<a href="<?php echo $this->_var['nav_0_27937500_1406602234']['url']; ?>" <?php if ($this->_var['nav_0_27937500_1406602234']['act'] == 1): ?>class="act"<?php endif; ?>  target="<?php echo $this->_var['nav_0_27937500_1406602234']['target']; ?>" ><?php echo $this->_var['nav_0_27937500_1406602234']['name_1']; ?></a>
				<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
				</div>
